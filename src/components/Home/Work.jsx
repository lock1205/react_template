...
const Work = () => {
  return (
    <div className="mt-20">
      <h2 className="text-3xl sm:text-5xl lg:text-6xl text-center mt-6 tracking-tight font-semibold font-customFontEn">
        Accelerate Your{' '}
        ...
        <div className="  p-12 w-full lg:w-1/2">
          {checklistItems.map((item, idx) => (
            <div key={idx} className=" flex mb-12">
              ...
              <div>
                <h5 className="mt-5 mb-2 text-xl font-customFontKr">
                  {item.title}
                </h5>
